...
TARGET = systemc-riscv-omnetpp$(D)$(EXE_SUFFIX)
TARGET_DIR = .
...
LIBS += -Wl,-rpath,$(abspath /home/ahmed/Desktop/Work_Productive_4.0/riscv_vp_source_code/libraries)
endif
